<?php
/**
 * Loop Pagination - A ClassicPress script for creating paginated links on archive-type pages.
 *
...
function loop_pagination( $args = array() ) {
	...
	$defaults = array(
		...
		'current'      => $current,
		'prev_next'    => true,
		//'prev_text'  => __( '&laquo; Previous' ), // This is the ClassicPress default.
		//'next_text'  => __( 'Next &raquo;' ), // This is the ClassicPress default.
		'show_all'     => false,
		'end_size'     => 1,
		'mid_size'     => 1,
		'add_fragment' => '',
