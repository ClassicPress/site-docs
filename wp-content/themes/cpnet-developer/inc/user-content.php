...
class DevHub_User_Submitted_Content {
	...
	public static function syntaxhighlighter_precode( $code ) {
		return str_replace( 'ClassicPress', 'Classic&#112;ress', $code );
	}
	...
	public static function comment_form_args( $comment = false, $context = '' ) {
		...
		$args = array(
			...
			. sprintf(
				...
				'https://docs.classicpress.net/wp-admin/profile.php',
			...
			'must_log_in'         => '<p>' . sprintf(
				...
				'https://docs.classicpress.net/wp-login.php/?redirect_to=' . urlencode( get_comments_link() )
			) . '</p>',
