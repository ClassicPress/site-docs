...
class DevHub_Registrations {
	...
	public static function register_post_types() {
		...
		// Plugin Guidelines
        register_post_type( 'wp-plugin-guidelines', array(
            'label'       => __( 'Plugin Guidelines', 'wporg' ),
            'labels'      => array(
                'name'               => __( 'Plugin Guidelines', 'wporg' ),
                'singular_name'      => __( 'Plugin Guideline', 'wporg' ),
                'all_items'          => __( 'Plugin Guideline', 'wporg' ),
                'new_item'           => __( 'New Plugin Guideline', 'wporg' ),
                'add_new'            => __( 'Add New', 'wporg' ),
                'add_new_item'       => __( 'Add New Plugin Guideline', 'wporg' ),
                'edit_item'          => __( 'Edit Plugin Guideline', 'wporg' ),
                'view_item'          => __( 'View Plugin Guideline', 'wporg' ),
                'search_items'       => __( 'Search Plugin Guidelines', 'wporg' ),
                'not_found'          => __( 'No Plugin Guidelines found', 'wporg' ),
                'not_found_in_trash' => __( 'No Plugin Guidelines found in trash', 'wporg' ),
                'parent_item_colon'  => __( 'Parent Plugin Guideline', 'wporg' ),
                'menu_name'          => __( 'Plugin Guidelines', 'wporg' ),
            ),
            'menu_icon'   => 'dashicons-admin-plugins',
            'public'      => true,
            'rewrite'     => array(
                'feeds'      => false,
                'slug'       => 'plugin-guidelines',
                'with_front' => false,
            ),
            'supports'    => $supports,
            'show_in_rest' => true,
        ...
        // User Guides
        register_post_type( 'wp-user-guides', array(
            'label'       => __( 'User Guides', 'wporg' ),
            'labels'      => array(
                'name'               => __( 'User Guides', 'wporg' ),
                'singular_name'      => __( 'User Guide', 'wporg' ),
                'all_items'          => __( 'User Guides', 'wporg' ),
                'new_item'           => __( 'New User Guide', 'wporg' ),
                'add_new'            => __( 'Add New', 'wporg' ),
                'add_new_item'       => __( 'Add New User Guide', 'wporg' ),
                'edit_item'          => __( 'Edit User Guide', 'wporg' ),
                'view_item'          => __( 'View User Guide', 'wporg' ),
                'search_items'       => __( 'Search User Guides', 'wporg' ),
                'not_found'          => __( 'No User Guides found', 'wporg' ),
                'not_found_in_trash' => __( 'No User Guides found in trash', 'wporg' ),
                'parent_item_colon'  => __( 'Parent User Guide', 'wporg' ),
                'menu_name'          => __( 'User Guides', 'wporg' ),
            ),
        ...
        // Developer Guides
		register_post_type( 'wp-developer-guides', array(
			'label'       => __( 'Developer Guides', 'wporg' ),
			'labels'      => array(
				'name'               => __( 'Developer Guides', 'wporg' ),
				'singular_name'      => __( 'Developer Guide', 'wporg' ),
				'all_items'          => __( 'Developer Guides', 'wporg' ),
				'new_item'           => __( 'New Developer Guide', 'wporg' ),
				'add_new'            => __( 'Add New', 'wporg' ),
				'add_new_item'       => __( 'Add New Developer Guide', 'wporg' ),
				'edit_item'          => __( 'Edit Developer Guide', 'wporg' ),
				'view_item'          => __( 'View Developer Guide', 'wporg' ),
				'search_items'       => __( 'Search Developer Guides', 'wporg' ),
				'not_found'          => __( 'No Developer Guides found', 'wporg' ),
				'not_found_in_trash' => __( 'No Developer Guides found in trash', 'wporg' ),
				'parent_item_colon'  => __( 'Parent Developer Guide', 'wporg' ),
				'menu_name'          => __( 'Developer Guides', 'wporg' ),
			),
	...
	public static function register_taxonomies() {
		...
		register_taxonomy( 'wp-parser-namespace', \DevHub\get_parsed_post_types(), array(
			'hierarchical'          => true,
			'label'                 => __( 'Namespaces', 'wp-parser' ),
			'public'                => true,
			'rewrite'               => array( 'with_front' => false, 'slug' => 'reference/namespace' ),
			'sort'                  => false,
			'update_count_callback' => '_update_post_term_count',
			'show_in_rest'          => true,
		) );
