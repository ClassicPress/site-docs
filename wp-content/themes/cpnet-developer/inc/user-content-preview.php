...
class DevHub_Note_Preview {
	...
	public static function scripts_and_styles() {
		$version = "20230121";
		if ( is_singular() ) {
			wp_enqueue_script( 'wporg-developer-tabs', get_template_directory_uri() . '/js/tabs.js', array( 'jquery' ), $version, true );
			wp_enqueue_script( 'wporg-developer-preview', get_template_directory_uri() . '/js/user-notes-preview.js', array( 'jquery', 'wporg-developer-function-reference', 'wporg-developer-tabs'  ), $version, true );
