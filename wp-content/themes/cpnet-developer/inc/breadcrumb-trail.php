<?php
/**
 * Breadcrumb Trail - A breadcrumb menu script for ClassicPress.
 *
...
class Breadcrumb_Trail {
	...
	/**
	 * Runs through the various ClassicPress conditional tags to check the current page being viewed.  Once
	...
	/**
	 * Searches for term parents of hierarchical taxonomies.  This function is similar to the ClassicPress
