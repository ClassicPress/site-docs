...
function theme_scripts_styles() {
	...
	wp_enqueue_script( 'wporg-developer-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), $version, true );
	wp_enqueue_script( 'wporg-developer-search', get_template_directory_uri() . '/js/search.js', array(), $version, true );
	wp_enqueue_script( 'wporg-developer-chapters', get_template_directory_uri() . '/js/chapters.js', array( 'jquery' ), $version );
	wp_enqueue_style( 'code-syntax-hglt', get_template_directory_uri() . '/stylesheets/prism.css', array(  ), $version );
	wp_enqueue_script( 'code-syntax-hglt', get_template_directory_uri() . '/js/prism.js', array(  ), $version, true );
}
