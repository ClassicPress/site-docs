...
function theme_scripts_styles() {
	...
	wp_enqueue_style( 'code-syntax-hglt', get_template_directory_uri() . '/stylesheets/prism.css', array(  ), '20200714' );
	wp_enqueue_script( 'code-syntax-hglt', get_template_directory_uri() . '/js/prism.js', array(  ), '20190604', true );
}
